 ...
 */
@Entity
public class BookFacade implements Serializable{
    @Id 
    ...
    public BookFacade(String name, String author, Integer publishedYear) {
        this.name = name;
        this.author = author;
        this.publishedYear = publishedYear;
    }
    public BookFacade(String name, String author, String publishedYear) {
        this.name = name;
        this.author = author;
    ...
    public boolean equals(Object obj) {
        ...
        final BookFacade other = (BookFacade) obj;
